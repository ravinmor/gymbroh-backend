...
routes.post("/users/acl/:id", ensuredAuthenticated(), is(adminRole), new CreateUserAccessControlListController().handle);
...
routes.get("/roles/:roleId", ensuredAuthenticated(), is(adminRole), new CreateRolePermissionController().handle);
